...
public class GlobalExceptionHandler {
    ...
    private static final Map<String, HttpStatus> STATUS_BY_CODE = Map.ofEntries(
            ...
            Map.entry("WECHAT_PAY_FAILED", HttpStatus.BAD_GATEWAY),
            Map.entry(
            ...
            Map.entry("ROOT_SPACE_QUOTA_EXCEEDED", HttpStatus.CONFLICT),
            Map.entry("SPACE_CATEGORY_QUOTA_EXCEEDED", HttpStatus.CONFLICT),
            Map.entry("CAVITY_ITEM_QUOTA_EXCEEDED", HttpStatus.CONFLICT),
            Map.entry("UPGRADE_REQUEST_PROCESSED", HttpStatus.CONFLICT),
            Map.entry("MEMBERSHIP_ORDER_NOT_FOUND", HttpStatus.NOT_FOUND),
            Map.entry("UPGRADE_REQUEST_NOT_FOUND", HttpStatus.NOT_FOUND),
            Map.entry("RENEWAL_NOT_SUPPORTED", HttpStatus.NOT_IMPLEMENTED),
